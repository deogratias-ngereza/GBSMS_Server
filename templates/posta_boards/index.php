...
<!--<div class="load-bar" style="margin-top:0px;">
  ...
  <div id="container">
    <div id="date_time">
        ...
        <p id="cat_heading">(Domestic Mail Schedule)</p>
        <p id="time"></p>
        <p id="date"></p>
    </div>
    <header>
                    ...
                    <table id="xdepartures" style="width: 100%;" ng-cloak>
                            ...
                            <tbody ng-cloak>
                                ...
                                <tr class="board_data_row" ng-repeat="route in ARRIVALS_LIST">
                                    ...
                                    <td style="width: 20%">{{route.carrier}}</td>
                                    <td style="width: 40%" id="from_field">{{route.io_from}}</td>
                                    <td style="width: 20%" >{{route.eta}}</td>
                                    <td style="width: 20%" >{{route.status}}</td>
                                </tr>
                                <!-- /******************************************* -->
                            </tbody>
                        </table>
                    ...
                    <table id="departures" style="width: 100%;" ng-cloak>
                            <tbody ng-cloak>
                                ...
                                <tr class="board_data_row" ng-repeat="route in ARRIVALS_LIST">
                                    <!--<td ><span class="glyphicon glyphicon-time" style="color:rgb(27, 141, 255);"></span>&nbsp&nbspTime</td>-->
                                    <td style="width: 20%">{{route.carrier}}</td>
                                    <td style="width: 40%" id="from_field">{{route.io_to}}</td>
                                    <td style="width: 20%" >{{route.etd}}</td>
                                    <td style="width: 20%" >{{route.status}}</td>
                                </tr>
                                <!-- /******************************************* -->
                            </tbody>
  ...
  <script type="text/javascript">
    APP.constant("DASH_CONSTANTS",{
        "SINGLE_GROUP_COUNTS" : 3,//no of items in a single board side
        "REFRESH_DELAY" : 2000,//10000, //seconds,
        "PULL_SERVER_DATA_DELAY" : 4000,//30000,

        //custom center info
        "CENTER_CODE" : "DAR_001",
        "REC_DEPARTMENT_ID" : <?php echo 3;?>,
        "CENTER_ID":1
    });
  </script>
